...
replace k8s.io/apimachinery => k8s.io/apimachinery v0.23.4-rc.0
...
replace k8s.io/code-generator => k8s.io/code-generator v0.23.4-rc.0
...
replace k8s.io/mount-utils => k8s.io/mount-utils v0.23.4-rc.0
